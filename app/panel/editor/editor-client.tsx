            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-6 space-y-5">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 bg-[#f8f5f5] p-5 rounded-2xl border border-[#dfb4b9]/30">
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between items-center mb-2"><label className={`text-[10px] font-black ${theme.textMuted} uppercase tracking-widest`}>Portada (Grid)</label><button type="button" onClick={handleSearchCover} className="flex items-center gap-2 px-3 py-1.5 rounded-lg text-[10px] font-black uppercase bg-[#e8c4df] text-[#2d1b30] hover:bg-[#dfb4b9] transition-all shadow-sm"><Search size={12}/> Buscar Grids</button></div>
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2"><label className={`text-[10px] font-black ${theme.textMuted} uppercase tracking-widest`}>Fondo (Hero)</label><button type="button" onClick={handleSearchCaptura} className="flex items-center gap-2 px-3 py-1.5 rounded-lg text-[10px] font-black uppercase bg-[#e8c4df] text-[#2d1b30] hover:bg-[#dfb4b9] transition-all shadow-sm"><Search size={12}/> Buscar Heroes</button></div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div>
                  <div className="flex justify-between items-center mb-2"><label className={`text-[11px] font-black ${theme.textMuted} uppercase tracking-widest`}>Descripción</label><button type="button" onClick={handleFetchWikipedia} className="flex items-center gap-2 px-4 py-2 rounded-xl text-[10px] font-black uppercase transition-all shadow-md bg-[#c47b98] text-white hover:bg-[#b06a87]"><BookOpen size={14}/> Extraer Wikipedia</button></div>
